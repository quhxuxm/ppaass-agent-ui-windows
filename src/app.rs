...
pub fn generate_start_btn_callback(
    ...
    Callback::from(move |event: web_sys::MouseEvent| {
        ...
        gloo::console::info!("Listening port: {}", listening_port_field.value());
    ...
    html! {
        <>
            ...
            <Container classes="input_field_panel">
                ...
                hint="Default proxy address is 127.0.0.1" input_ref={&proxy_address_field_ref}/>
                <InputField id="listening_port" label={"Listening port:"}
                place_holder={"Enter listening port"}
                hint="Default listening port is 10080" input_ref={&listening_port_field_ref}/>
            </Container>
